...
(global-set-key (kbd "C-x g u") (lambda () (interactive) (+magit-status-in (expand-file-name "~/sourcecode/gameengine/UnrealEngine/"))))
(global-set-key (kbd "C-x g e") (lambda () (interactive) (+magit-status-in (expand-file-name "~/sourcecode/editor/emacs-fswork-debug/"))))
...
(global-set-key (kbd "C-x g n") (lambda () (interactive) (+magit-status-in (expand-file-name "~/sourcecode/editor/neovim/"))))
(global-set-key (kbd "C-x g o") (lambda () (interactive) (+magit-status-in (expand-file-name "~/sourcecode/editor/vscode/"))))
...
(with-eval-after-load 'evil
  (evil-define-key 'normal 'global
    ...
    (kbd ",gu") (lambda () (interactive) (+magit-status-in (expand-file-name "~/sourcecode/gameengine/UnrealEngine/")))
    (kbd ",ge") (lambda () (interactive) (+magit-status-in (expand-file-name "~/sourcecode/editor/emacs-fswork-debug/")))
    ...
    (kbd ",gn") (lambda () (interactive) (+magit-status-in (expand-file-name "~/sourcecode/editor/neovim/")))
    (kbd ",go") (lambda () (interactive) (+magit-status-in (expand-file-name "~/sourcecode/editor/vscode/")))
